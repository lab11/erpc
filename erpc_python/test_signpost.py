...
def server(signpost):
    ...
    transport = erpc.transport.FramedSignpostTransport(signpost)
    server = erpc.simple_server.SimpleServer(transport, erpc.basic_codec.BasicCodec, signpost)
